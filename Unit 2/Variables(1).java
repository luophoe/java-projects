...
public class Variables {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("A square with a side of 7 would have a perimeter of " + perimeter +"cm, an area of " + area + "cm.");
        ...
        System.out.println("A rectangle with a length of 8 and a length of 5 would have a perimeter of " + perimeterrec + "cm, an area of " + arearec + "cm.");
